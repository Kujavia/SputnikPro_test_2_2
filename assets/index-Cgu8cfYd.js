(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const m of n.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&a(m)}).observe(document,{childList:!0,subtree:!0});function o(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=o(r);fetch(r.href,n)}})();window.check_mark=function(){const e=document.getElementById("check-mark_button");e.style.display="inline",setTimeout(function(){e.style.display="none"},5e3)};window.showContent_listing=function(){fetch("./src/html/listing.html").then(e=>{if(!e.ok)throw new Error("Network response was not ok "+e.statusText);return e.text()}).then(e=>{document.getElementById("mainContent").innerHTML=e}).catch(e=>{console.error("There has been a problem with your fetch operation:",e)})};window.showContent_newProducts=function(){fetch("./src/html/new_products.html").then(e=>{if(!e.ok)throw new Error("Network response was not ok "+e.statusText);return e.text()}).then(e=>{document.getElementById("mainContent").innerHTML=e}).catch(e=>{console.error("There has been a problem with your fetch operation:",e)})};window.showContent_locks=function(){fetch("./src/html/locks.html").then(e=>{if(!e.ok)throw new Error("Network response was not ok "+e.statusText);return e.text()}).then(e=>{document.getElementById("mainContent").innerHTML=e}).catch(e=>{console.error("There has been a problem with your fetch operation:",e)})};window.showContent_outputAssort=function(){fetch("./src/html/output_assort.html").then(e=>{if(!e.ok)throw new Error("Network response was not ok "+e.statusText);return e.text()}).then(e=>{document.getElementById("mainContent").innerHTML=e}).catch(e=>{console.error("There has been a problem with your fetch operation:",e)})};window.showContent_tender=function(){fetch("./src/html/tender.html").then(e=>{if(!e.ok)throw new Error("Network response was not ok "+e.statusText);return e.text()}).then(e=>{document.getElementById("mainContent").innerHTML=e}).catch(e=>{console.error("There has been a problem with your fetch operation:",e)})};window.showContent_priceChange=function(){fetch("./src/html/price_change.html").then(e=>{if(!e.ok)throw new Error("Network response was not ok "+e.statusText);return e.text()}).then(e=>{document.getElementById("mainContent").innerHTML=e}).catch(e=>{console.error("There has been a problem with your fetch operation:",e)})};window.showContent_promoRatio=function(){fetch("./src/html/promo_ratio.html").then(e=>{if(!e.ok)throw new Error("Network response was not ok "+e.statusText);return e.text()}).then(e=>{document.getElementById("mainContent").innerHTML=e}).catch(e=>{console.error("There has been a problem with your fetch operation:",e)})};window.showContent_planner=function(){fetch("./src/html/planner.html").then(e=>{if(!e.ok)throw new Error("Network response was not ok "+e.statusText);return e.text()}).then(e=>{document.getElementById("mainContent").innerHTML=e}).catch(e=>{console.error("There has been a problem with your fetch operation:",e)})};window.showContent_summaryPlan=function(){fetch("./src/html/summary_plan.html").then(e=>{if(!e.ok)throw new Error("Network response was not ok "+e.statusText);return e.text()}).then(e=>{document.getElementById("mainContent").innerHTML=e}).catch(e=>{console.error("There has been a problem with your fetch operation:",e)})};window.tbRegAssortButton=function(){const t=document.getElementById("regular_assort_method").value,a=document.getElementById("regular_assort__aggregation-time").value,n=document.getElementById("regular_assort__aggregation-geo").value,d=document.getElementById("regular_assort__aggregation-scu").value,c=document.getElementById("regular_assort_period").value;let s;if(t==="ra_not_selected"||a==="not_selected"||n==="not_selected"||d==="not_selected"||c==="not_selected"){const l=document.getElementById("tb_regular_assort_results"),h=l.contentDocument||l.contentWindow.document;h.open(),h.write(`<html>
            ...
            <body>
              ...
              <body>
                ...
                <body>
                    <table>
                        <thead>
                            <tr>`),Object.keys(a.data[0]).forEach(d=>{n.write(`<th>${d}</th>`)}),n.write("</tr></thead><tbody>"),a.data.forEach(d=>{n.write("<tr>"),Object.values(d).forEach(i=>{n.write(`<td>${i}</td>`)}),n.write("</tr>")}),n.write("</tbody></table>"),n.write("</body></html>"),n.close()}})};function T(){document.getElementById("new_product__modal").style.display="flex"}function M(){document.getElementById("new_product__modal").style.display="none"}function D(){const e=document.querySelectorAll('#new_product__modalContent input[type="checkbox"]'),t=[];e.forEach(o=>{o.checked&&t.push(o.name)})}window.newProductOptimizationButton=T;window.newProductCloseModalButton=M;window.newProductSaveModalButton=D;window.newProduct_PreviewButton=function(){const t=document.getElementById("new_product__aggregation-time").value,a=document.getElementById("new_product__aggregation-geo").value,n=document.getElementById("new_product__aggregation-group").value,d=document.getElementById("new_product__aggregation-parameter").value;let i;if(t!=="not_selected"&&a!=="not_selected"&&n!=="not_selected"&&d!=="not_selected")i="./images/demo_file/test_forecast_csv.csv";else if(t==="not_selected"||a==="not_selected"||n==="not_selected"||d==="not_selected"){const c=document.getElementById("new_product_PreviewIframe"),s=c.contentDocument||c.contentWindow.document;s.open(),s.write(`<html>
              <head>
                  <title>Сообщение</title>
                  <style>
                      body {
              ...
              <body>
              ...
              </html>`),s.close();return}else if(selectedMethod==="promo_weighted__custom")i="./images/demo_file/test_forecast_csv2.csv";else{console.warn("Неизвестный метод прогнозирования:",selectedMethod);return}Papa.parse(i,{download:!0,header:!0,complete:function(c){const s=document.getElementById("new_product_PreviewIframe"),l=s.contentDocument||s.contentWindow.document;l.open(),l.write(`<html>
                <head>
                    <title>CSV Data</title>
                    <style>
                        body {
                ...
                <body>
                    <table>
                        <thead>
                            <tr>`),Object.keys(c.data[0]).forEach(u=>{l.write(`<th>${u}</th>`)}),l.write("</tr></thead><tbody>"),c.data.forEach(u=>{l.write("<tr>"),Object.values(u).forEach(g=>{l.write(`<td>${g}</td>`)}),l.write("</tr>")}),l.write("</tbody></table>"),l.write("</body></html>"),l.close()}})};function A(){document.getElementById("summaryPlan_modal").style.display="flex"}function O(){document.getElementById("summaryPlan_modal").style.display="none"}function L(){const e=document.querySelectorAll('#summaryPlan_modalContent input[type="checkbox"]'),t=[];e.forEach(o=>{o.checked&&t.push(o.name)})}window.summaryPlan_OptimizationButton=A;window.summaryPlan_closeModalButton=O;window.summaryPlan_saveModalButton=L;window.summaryPlan_PreviewButton=function(){const t=document.getElementById("summary_plan_time").value,a=document.getElementById("summary_plan_geography").value,n=document.getElementById("summary_plan_scu").value,d=document.getElementById("summary_plan_method").value;let i;if(t!=="not_selected"&&a!=="not_selected"&&n!=="not_selected"&&d!=="not_selected")i="./images/demo_file/test_forecast_csv.csv";else if(t==="not_selected"||a==="not_selected"||n==="not_selected"||d==="not_selected"){const c=document.getElementById("summaryPlan_PreviewIframe"),s=c.contentDocument||c.contentWindow.document;s.open(),s.write(`<html>
              <head>
                  <title>Сообщение</title>
                  <style>
                      body {
              ...
              <body>
              ...
              </html>`),s.close();return}else{console.warn("Неизвестный метод прогнозирования:",selectedMethod);return}Papa.parse(i,{download:!0,header:!0,complete:function(c){const s=document.getElementById("summaryPlan_PreviewIframe"),l=s.contentDocument||s.contentWindow.document;l.open(),l.write(`<html>
                <head>
                    <title>CSV Data</title>
                    <style>
                        body {
                ...
                <body>
                    <table>
                        <thead>
                            <tr>`),Object.keys(c.data[0]).forEach(u=>{l.write(`<th>${u}</th>`)}),l.write("</tr></thead><tbody>"),c.data.forEach(u=>{l.write("<tr>"),Object.values(u).forEach(g=>{l.write(`<td>${g}</td>`)}),l.write("</tr>")}),l.write("</tbody></table>"),l.write("</body></html>"),l.close()}})};function N(){v(),document.getElementById("planner_weeklyModal").style.display="block"}function y(e){document.getElementById(e).style.display="none"}function v(){y("planner_weeklyModal"),y("timeModal"),y("checkboxModal")}window.onclick=function(e){e.target.classList.contains("modal")&&v()};function j(){const e=document.getElementById("planner__scenarioName").value,t=document.getElementById("planner__block"),o=t.options[t.selectedIndex].text,a=document.getElementById("planner__scenarioCustom"),r=a.options[a.selectedIndex].text,n=document.getElementById("planner_interval").value,m=document.getElementById("planner_selectedTime").value,d=document.getElementById("planner_selectedStartDate").value,i=document.getElementById("planner_selectedEndDate").value,c=document.getElementById("planner_Iframe"),s=c.contentDocument||c.contentWindow.document;s.body.innerHTML=`        <style>
            table {
                width: 100%;
                border-collapse: collapse;
                margin-top: 20px;
    ...
    <table>
        ...
        }`,o.head.appendChild(a);const r=o.createElement("table");if(r.innerHTML="",e.length===0){r.innerHTML='<tr><td colspan="100%">Нет данных для отображения</td></tr>',o.body.appendChild(r);return}const n=Object.keys(e[0]),m=document.createElement("tr");for(let i=6;i<n.length;i++){const c=document.createElement("th");c.textContent=n[i],m.appendChild(c)}r.appendChild(m);const d=["WAPE, %","BIAS, %","Доля, %","Доля, %2","недопрогноз, %","перепрогноз, %"];e.forEach(i=>{const c=document.createElement("tr");for(let s=6;s<n.length;s++){const l=document.createElement("td");let h=i[n[s]];typeof h=="number"&&(i.МЕРЫ&&d.includes(i.МЕРЫ)?h=(h*100).toFixed(2)+"%":h=h.toFixed(2)),l.textContent=h,c.appendChild(l)}r.appendChild(c)}),o.body.appendChild(r)},fetch("./public/images/demo_file/regAssort2.xlsx").then(e=>{if(!e.ok)throw new Error("Сеть не отвечает");return e.arrayBuffer()}).then(e=>{const t=XLSX.read(e,{type:"array"}),o=t.SheetNames[0],a=t.Sheets[o],r=XLSX.utils.sheet_to_json(a),n=window.filterData(r);window.displayTable(n)}).catch(e=>{console.error("Ошибка загрузки файла:",e)})};
