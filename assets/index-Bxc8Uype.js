            ...
            <body>
              ...
              <body>
                ...
                <body>
                    <table>
                        <thead>
                            <tr>`),Object.keys(a.data[0]).forEach(i=>{n.write(`<th>${i}</th>`)}),n.write("</tr></thead><tbody>"),a.data.forEach(i=>{n.write("<tr>"),Object.values(i).forEach(d=>{n.write(`<td>${d}</td>`)}),n.write("</tr>")}),n.write("</tbody></table>"),n.write("</body></html>"),n.close()}})};function T(){document.getElementById("new_product__modal").style.display="flex"}function M(){document.getElementById("new_product__modal").style.display="none"}function D(){const e=document.querySelectorAll('#new_product__modalContent input[type="checkbox"]'),t=[];e.forEach(o=>{o.checked&&t.push(o.name)})}window.newProductOptimizationButton=T;window.newProductCloseModalButton=M;window.newProductSaveModalButton=D;window.newProduct_PreviewButton=function(){const t=document.getElementById("new_product__aggregation-time").value,a=document.getElementById("new_product__aggregation-geo").value,n=document.getElementById("new_product__aggregation-group").value,i=document.getElementById("new_product__aggregation-parameter").value;let d;if(t!=="not_selected"&&a!=="not_selected"&&n!=="not_selected"&&i!=="not_selected")d="./images/demo_file/test_forecast_csv.csv";else if(t==="not_selected"||a==="not_selected"||n==="not_selected"||i==="not_selected"){const c=document.getElementById("new_product_PreviewIframe"),s=c.contentDocument||c.contentWindow.document;s.open(),s.write(`<html>
              <head>
                  <title>Сообщение</title>
                  <style>
                      body {
              ...
              <body>
                ...
                <body>
                    <table>
                        <thead>
                            <tr>`),Object.keys(c.data[0]).forEach(u=>{l.write(`<th>${u}</th>`)}),l.write("</tr></thead><tbody>"),c.data.forEach(u=>{l.write("<tr>"),Object.values(u).forEach(g=>{l.write(`<td>${g}</td>`)}),l.write("</tr>")}),l.write("</tbody></table>"),l.write("</body></html>"),l.close()}})};function A(){document.getElementById("summaryPlan_modal").style.display="flex"}function O(){document.getElementById("summaryPlan_modal").style.display="none"}function L(){const e=document.querySelectorAll('#summaryPlan_modalContent input[type="checkbox"]'),t=[];e.forEach(o=>{o.checked&&t.push(o.name)})}window.summaryPlan_OptimizationButton=A;window.summaryPlan_closeModalButton=O;window.summaryPlan_saveModalButton=L;window.summaryPlan_PreviewButton=function(){const t=document.getElementById("summary_plan_time").value,a=document.getElementById("summary_plan_geography").value,n=document.getElementById("summary_plan_scu").value,i=document.getElementById("summary_plan_method").value;let d;if(t!=="not_selected"&&a!=="not_selected"&&n!=="not_selected"&&i!=="not_selected")d="./images/demo_file/test_forecast_csv.csv";else if(t==="not_selected"||a==="not_selected"||n==="not_selected"||i==="not_selected"){const c=document.getElementById("summaryPlan_PreviewIframe"),s=c.contentDocument||c.contentWindow.document;s.open(),s.write(`<html>
              <head>
                  <title>Сообщение</title>
                  <style>
                      body {
